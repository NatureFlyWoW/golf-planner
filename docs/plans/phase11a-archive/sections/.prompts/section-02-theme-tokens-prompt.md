...
Generate content for section `section-02-theme-tokens` (filename: `section-02-theme-tokens.md`).
...
for `section-02-theme-tokens` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-02-theme-tokens.md`
