...
Generate content for section `section-06-postprocessing` (filename: `section-06-postprocessing.md`).
...
for `section-06-postprocessing` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-06-postprocessing.md`
