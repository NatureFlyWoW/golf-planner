...
Generate content for section `section-04-data-panels` (filename: `section-04-data-panels.md`).
...
for `section-04-data-panels` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-04-data-panels.md`
