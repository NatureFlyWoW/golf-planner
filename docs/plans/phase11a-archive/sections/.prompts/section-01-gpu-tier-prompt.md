...
Generate content for section `section-01-gpu-tier` (filename: `section-01-gpu-tier.md`).
...
for `section-01-gpu-tier` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-01-gpu-tier.md`
