...
Generate content for section `section-03-dark-theme` (filename: `section-03-dark-theme.md`).
...
for `section-03-dark-theme` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-03-dark-theme.md`
