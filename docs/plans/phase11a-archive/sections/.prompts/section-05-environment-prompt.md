...
Generate content for section `section-05-environment` (filename: `section-05-environment.md`).
...
for `section-05-environment` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-05-environment.md`
