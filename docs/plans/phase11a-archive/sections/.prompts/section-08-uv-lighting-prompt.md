...
Generate content for section `section-08-uv-lighting` (filename: `section-08-uv-lighting.md`).
...
for `section-08-uv-lighting` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-08-uv-lighting.md`
