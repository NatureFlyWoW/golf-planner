...
Generate content for section `section-11-perf-fixes` (filename: `section-11-perf-fixes.md`).
...
for `section-11-perf-fixes` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-11-perf-fixes.md`
