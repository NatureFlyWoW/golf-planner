...
Generate content for section `section-07-reflections` (filename: `section-07-reflections.md`).
...
for `section-07-reflections` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-07-reflections.md`
