...
Generate content for section `section-09-godrays` (filename: `section-09-godrays.md`).
...
for `section-09-godrays` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-09-godrays.md`
