...
Generate content for section `section-12-visual-tests` (filename: `section-12-visual-tests.md`).
...
for `section-12-visual-tests` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/sections/section-12-visual-tests.md`
