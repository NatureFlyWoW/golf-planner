...
Generate content for section `section-10-feature-migration` (filename: `section-10-feature-migration.md`).
...
for `section-10-feature-migration` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-10-feature-migration.md`
