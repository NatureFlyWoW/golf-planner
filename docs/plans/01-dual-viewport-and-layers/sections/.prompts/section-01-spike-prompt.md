...
Generate content for section `section-01-spike` (filename: `section-01-spike.md`).
...
for `section-01-spike` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-01-spike.md`
