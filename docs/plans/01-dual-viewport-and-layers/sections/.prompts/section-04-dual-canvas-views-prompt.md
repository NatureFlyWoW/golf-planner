...
Generate content for section `section-04-dual-canvas-views` (filename: `section-04-dual-canvas-views.md`).
...
for `section-04-dual-canvas-views` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-04-dual-canvas-views.md`
