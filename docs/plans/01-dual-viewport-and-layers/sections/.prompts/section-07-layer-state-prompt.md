...
Generate content for section `section-07-layer-state` (filename: `section-07-layer-state.md`).
...
for `section-07-layer-state` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-07-layer-state.md`
