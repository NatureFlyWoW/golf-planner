...
Generate content for section `section-06-event-isolation` (filename: `section-06-event-isolation.md`).
...
for `section-06-event-isolation` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-06-event-isolation.md`
