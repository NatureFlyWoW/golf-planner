...
Generate content for section `section-03-split-pane-layout` (filename: `section-03-split-pane-layout.md`).
...
for `section-03-split-pane-layout` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-03-split-pane-layout.md`
