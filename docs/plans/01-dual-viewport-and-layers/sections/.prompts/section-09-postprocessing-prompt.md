...
Generate content for section `section-09-postprocessing` (filename: `section-09-postprocessing.md`).
...
for `section-09-postprocessing` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/01-dual-viewport-and-layers/sections/section-09-postprocessing.md`
