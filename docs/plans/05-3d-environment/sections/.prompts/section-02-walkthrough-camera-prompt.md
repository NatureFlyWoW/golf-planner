...
Generate content for section `section-02-walkthrough-camera` (filename: `section-02-walkthrough-camera.md`).
...
for `section-02-walkthrough-camera` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-02-walkthrough-camera.md`
