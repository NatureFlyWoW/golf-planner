...
Generate content for section `section-05-ground-plane` (filename: `section-05-ground-plane.md`).
...
for `section-05-ground-plane` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-05-ground-plane.md`
