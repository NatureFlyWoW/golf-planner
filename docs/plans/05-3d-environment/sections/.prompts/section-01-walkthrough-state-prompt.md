...
Generate content for section `section-01-walkthrough-state` (filename: `section-01-walkthrough-state.md`).
...
for `section-01-walkthrough-state` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-01-walkthrough-state.md`
