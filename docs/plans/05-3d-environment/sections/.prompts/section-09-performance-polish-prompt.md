...
Generate content for section `section-09-performance-polish` (filename: `section-09-performance-polish.md`).
...
for `section-09-performance-polish` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-09-performance-polish.md`
