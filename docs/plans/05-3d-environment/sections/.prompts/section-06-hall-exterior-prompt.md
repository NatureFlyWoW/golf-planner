...
Generate content for section `section-06-hall-exterior` (filename: `section-06-hall-exterior.md`).
...
for `section-06-hall-exterior` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-06-hall-exterior.md`
