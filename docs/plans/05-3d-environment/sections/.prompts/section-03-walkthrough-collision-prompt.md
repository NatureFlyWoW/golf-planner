...
Generate content for section `section-03-walkthrough-collision` (filename: `section-03-walkthrough-collision.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/claude-plan.md` - Full implementation plan
2. `/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/claude-plan-tdd.md` - Test stubs for each section
3. `/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-walkthrough-collision` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/golf-planner/docs/plans/05-3d-environment/sections/section-03-walkthrough-collision.md`
