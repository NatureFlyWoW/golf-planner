...
Generate content for section `section-02-viewport-aware-scene` (filename: `section-02-viewport-aware-scene.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/claude-plan.md` - Full implementation plan
2. `/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/claude-plan-tdd.md` - Test stubs for each section
3. `/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-viewport-aware-scene` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-02-viewport-aware-scene.md`
