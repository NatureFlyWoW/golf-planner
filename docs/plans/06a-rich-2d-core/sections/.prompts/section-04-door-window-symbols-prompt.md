...
Generate content for section `section-04-door-window-symbols` (filename: `section-04-door-window-symbols.md`).
...
for `section-04-door-window-symbols` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-04-door-window-symbols.md`
