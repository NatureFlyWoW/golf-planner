...
Generate content for section `section-08-lod-system` (filename: `section-08-lod-system.md`).
...
for `section-08-lod-system` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-08-lod-system.md`
