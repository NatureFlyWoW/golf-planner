...
Generate content for section `section-03-architectural-walls` (filename: `section-03-architectural-walls.md`).
...
for `section-03-architectural-walls` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-03-architectural-walls.md`
