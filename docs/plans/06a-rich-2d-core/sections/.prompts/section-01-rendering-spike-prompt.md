...
Generate content for section `section-01-rendering-spike` (filename: `section-01-rendering-spike.md`).
...
for `section-01-rendering-spike` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-01-rendering-spike.md`
