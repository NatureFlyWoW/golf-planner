...
Generate content for section `section-05-status-bar` (filename: `section-05-status-bar.md`).
...
for `section-05-status-bar` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-05-status-bar.md`
