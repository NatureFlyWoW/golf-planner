...
Generate content for section `section-06-grid-refinement` (filename: `section-06-grid-refinement.md`).
...
for `section-06-grid-refinement` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-06-grid-refinement.md`
