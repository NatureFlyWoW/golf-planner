...
Generate content for section `section-07-textured-holes` (filename: `section-07-textured-holes.md`).
...
for `section-07-textured-holes` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-07-textured-holes.md`
