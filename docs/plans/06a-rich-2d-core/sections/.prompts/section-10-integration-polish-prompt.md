...
Generate content for section `section-10-integration-polish` (filename: `section-10-integration-polish.md`).
...
for `section-10-integration-polish` to understand what this section should contain.
...
`/mnt/c/Users/Caus/Golf_Plan/docs/plans/06a-rich-2d-core/sections/section-10-integration-polish.md`
